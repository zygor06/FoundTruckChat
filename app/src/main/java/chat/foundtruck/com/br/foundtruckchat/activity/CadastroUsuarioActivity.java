...
public class CadastroUsuarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = findViewById(R.id.text_cadastro);

        cadastroNome.setTypeface(menu);
        cadastroEmail.setTypeface(menu);
        cadastroSenha.setTypeface(menu);
        cadastroNome.setTextSize(25);
        cadastroSenha.setTextSize(25);
        cadastroEmail.setTextSize(25);

        btnCadastrar.setTypeface(signature);
        btnCadastrar.setTextSize(28);

        text.setTypeface(menu);
        text.setTextSize(28);
